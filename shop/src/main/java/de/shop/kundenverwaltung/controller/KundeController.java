...
//		//menuGroup.getChildren().add(item);
	 ...
	 */
	//TODO auskommentiert weil kein Plan von findeKundeByPrefix xD
//	@TransactionAttribute(REQUIRED)
...
//	}
	 ...
	 * @return URL fuer Anzeige des gefundenen Kunden; sonst null
	 */
	//TODO findKundeByNachname funktioniert noch nicht
//	@TransactionAttribute(REQUIRED)
...
//	}
	 ...
	 */
	//TODO findNachnamenByPrefix funktioniert noch nicht
//	@TransactionAttribute(REQUIRED)
